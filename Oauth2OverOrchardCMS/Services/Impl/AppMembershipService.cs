...
{
    [OrchardSuppressDependency("Orchard.Security.NullMembershipService"), OrchardSuppressDependency("Orchard.Users.Services.MembershipService")]
    public class AppMembershipService:IMembershipService,ICommonService
    {
        ...
        private readonly IAccountEventHandler _accountEventHandlers;
        ...
        public IUser CreateUser(CreateUserParams createUserParams)
        {
            ...
            user.UserName = createUserParams.Username.Split(new char[]{'|'})[0];
            user.Email = createUserParams.Email;
            user.NormalizedUserName = createUserParams.Username.Split(new char[] { '|' })[0].ToLowerInvariant();
        ...
        public IUser GetUser(string username)
        {
            ...
            var user=_orchardServices.ContentManager.Query<UserPart, UserPartRecord>().Where(u => u.UserName == lowerName).List().FirstOrDefault(); 
